...
public class OpenApiConfiguration {
    @Value("${spring.application.name:Anamnesis-LLM Service API}")
    String applicationName;

    @Value("${api.description:Anamnesis-LLM Service API for AylluCare/B4U Platform}")
    ...
    public OpenAPI anamnesisServiceOpenApi() {
        ...
        openApi.info(new Info()
                ...
                .externalDocs(new ExternalDocumentation()
                        .description("Anamnesis-LLM Service API Documentation")
