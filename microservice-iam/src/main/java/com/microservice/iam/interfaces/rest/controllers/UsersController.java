...
import com.microservice.iam.domain.model.queries.GetAllUsersQuery;
import com.microservice.iam.domain.model.queries.GetUserByIdQuery;
...
/**
 * Controller to handle user endpoints for AylluCare/B4U.
 * <p>
 *     Simplified architecture following CQRS pattern.
 * </p>
 */
@RestController
